...
{
	public static StudentWrapper ToWrapper(this Student student) => new()
	{
		Id = student.Id,
	...
	public static Student ToDao(this StudentWrapper studentWrapper) => new()
	{
	...
	public static List<Rating> ToRatingDao(this StudentWrapper studentWrapper)
	{
		...
		{
			studentWrapper.Math.Split(',').ToList()
		...
		{
			studentWrapper.Physics.Split(',').ToList()
		...
		{
			studentWrapper.PolishLang.Split(',').ToList()
		...
		{
			studentWrapper.ForeignLang.Split(',').ToList()
		...
		{
			studentWrapper.Technology.Split(',').ToList()
